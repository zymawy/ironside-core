...
namespace Zymawy\Ironside\Http\Controllers\Dashboard\Settings;
...
class SettingsController extends AdminController
{
	...
	public function index()
	{
		...
		return $this->view('ironside::settings.settings.index')->with('items', Settings::all());
	}
	...
	{
		return $this->view('ironside::settings.settings.create_edit');
	}
	...
	{
		return $this->view('ironside::settings.settings.show')->with('item', $setting);
	}
	...
	{
		return $this->view('ironside::settings.settings.create_edit')->with('item', $setting);
	}
