...
namespace Zymawy\Ironside\Http\Controllers\Dashboard\Documents;

use Redirect;
use App\Http\Requests;
use Zymawy\Ironside\Models\DocumentCategory;
...
class CategoriesController extends AdminController
{
    ...
    public function index()
    {
        ...
        return $this->view('ironside::documents.categories.index')->with('items', DocumentCategory::all());
    }
    ...
    {
        return $this->view('ironside::documents.categories.create_edit');
    }
    ...
    {
        return $this->view('ironside::documents.categories.create_edit')->with('item', $category);
    }
