...
class ArticlesController extends AdminController
{
    ...
    public function index()
    {
        ...
        return $this->view('ironside::blog.index', compact('items'));
    }
    ...
    public function create()
    {
        ...
        return $this->view('ironside::blog.create_edit', compact('categories'));
    }
    ...
    {
        return $this->view('ironside::blog.show')->with('item', $article);
    }
    ...
    public function edit(Article $article)
    {
        ...
        return $this->view('ironside::blog.create_edit', compact('categories'))->with('item', $article);
    }
