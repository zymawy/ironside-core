...
namespace Zymawy\Ironside\Http\Controllers\Dashboard\Blog;
...
class CategoriesController extends AdminController
{
	...
	public function index()
	{
		...
		return $this->view('ironside::blog.categories.index')->with('items', ArticleCategory::all());
	}
	...
	{
		return $this->view('ironside::blog.categories.create_edit');
	}
	...
	{
		return $this->view('ironside::blog.categories.show')->with('item', $category);
	}
	...
	{
		return $this->view('ironside::blog.categories.create_edit')->with('item', $category);
	}
