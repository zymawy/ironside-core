...
namespace Zymawy\Ironside\Http\Controllers\Dashboard\Photos;
...
class AlbumsController extends AdminController
{
    ...
    public function index()
    {
        ...
        return $this->view('ironside::photos.albums.index')->with('items', $items);
    }
    ...
    {
        return $this->view('ironside::photos.albums.create_edit');
    }
    ...
    {
        return $this->view('ironside::photos.albums.create_edit')->with('item', $album);
    }
