...
namespace Zymawy\Ironside\Http\Controllers\Dashboard\Pages;
...
class PagesController extends AdminController
{
    ...
    public function index()
    {
        ...
        return $this->view('ironside::pages.index')->with('items', $items);
    }
    ...
    public function create()
    {
        ...
        return $this->view('ironside::pages.create_edit', compact('parents', 'banners'));
    }
    ...
    {
        return $this->view('ironside::pages.show')->with('item', $page);
    }
    ...
    public function edit(Page $page)
    {
        ...
        return $this->view('ironside::pages.create_edit', compact('parents', 'banners'))->with('item', $page);
    }
