...
namespace Zymawy\Ironside\Http\Controllers\Dashboard\NewsEvents;

use Redirect;
use App\Http\Requests;
use Zymawy\Ironside\Models\NewsCategory;
...
class CategoriesController extends AdminController
{
	...
	public function index()
	{
		...
		return $this->view('ironside::news_events.categories.index')->with('items', NewsCategory::all());
	}
	...
	{
		return $this->view('ironside::news_events.categories.create_edit');
	}
	...
	{
		return $this->view('ironside::news_events.categories.show')->with('item', $category);
	}
	...
	{
		return $this->view('ironside::news_events.categories.create_edit')->with('item', $category);
	}
