...
class NewsController extends AdminController
{
    ...
    public function index()
    {
        ...
        return $this->view('ironside::news_events.index', compact('items'));
    }
    ...
    public function create()
    {
        ...
        return $this->view('ironside::news_events.create_edit', compact('categories'));
    }
    ...
    {
        return $this->view('ironside::news_events.show')->with('item', $news);
    }
    ...
    public function edit(News $news)
    {
        ...
        return $this->view('ironside::news_events.create_edit', compact('categories'))->with('item', $news);
    }
