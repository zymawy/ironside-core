...
namespace Zymawy\Ironside\Http\Controllers\Dashboard\Newsletter;
...
class SubscribersController extends AdminController
{
	...
	public function index()
	{
		...
		return $this->view('ironside::newsletters.subscribers.index')->with('items', NewsletterSubscriber::all());
	}
	...
	{
		return $this->view('ironside::newsletters.subscribers.create_edit');
	}
	...
	{
		return $this->view('ironside::newsletters.subscribers.show')->with('item', $subscriber);
	}
	...
	{
		return $this->view('ironside::newsletters.subscribers.create_edit')->with('item', $subscriber);
	}
