...
class BannersController extends AdminController
{
    ...
    public function index()
    {
        ...
        return $this->view('ironside::banners.index')->with('items', Banner::all());
    }
    ...
    {
        return $this->view('ironside::banners.create_edit');
    }
    ...
    {
        return $this->view('ironside::banners.show')->with('item', $banner);
    }
    ...
    {
        return $this->view('ironside::banners.create_edit')->with('item', $banner);
    }
