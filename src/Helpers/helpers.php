...
if (!function_exists('url_dashboard')) {
    /**
     ...
     * @return string
     */
    function url_dashboard($path = null, $parameters = [], $secure = null)
    {
        return app('url')->to('dashboard/' . $path, $parameters, $secure);
    }
}

if (!function_exists('route_dashboard')) {
    /**
     ...
     * @return string
     */
    function route_dashboard($name, $parameters = [], $absolute = true, $route = null)
    {
