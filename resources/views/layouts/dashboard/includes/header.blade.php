                        ...
                        <ul>
                            <li>
                                <div class="drop-title">
                                    {!! trans('ironside::dashboard/general.activities_count_message')  !!}
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="nav-link text-center" href="/dashboard/history/website">
                                    <strong>
                                        {{ trans('ironside::dashboard/general.see_all_activities') }}
                                    </strong>
            ...
            <!-- Profile -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true"
                       aria-expanded="false">
                        <img src="{{ Auth::check() ? Gravatar::get(auth()->user()->email) : '/images/users/5.jpg' }}" alt="user"
                             class="profile-pic"
                        />
                    </a>
