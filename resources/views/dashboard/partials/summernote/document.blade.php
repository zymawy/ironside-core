            ...
            <div class="modal-content">
                <div class="modal-header alert-info">
                    ...
                    <h4 class="modal-title">
                        {{ trans('ironside::dashboard/general.document.insert-document-link') }}
                    </h4>
                </div>
                <div class="modal-body">
                    <form id="form-modal-documents">
                        <div class="form-group">
                            <label for="name">
                                {{ trans('ironside::dashboard/general.name') }}
                            </label>
                            <input type="text" class="form-control" name="name"
                                   placeholder="{{ trans('ironside::dashboard/general.text_to_display_placeholder') }}" value="">
                        </div>
                        <div class="form-group">
                            <label for="document">
                                {{ trans('ironside::dashboard/general.document.document') }}
                            </label>
                            {!! form_select('document_id', ([0 => trans('ironside::dashboard/general.select_document_placeholder')] + $documents), null, ['class' => 'select2 form-control']) !!}
                        </div>
                        <div class="checkbox">
                            <label>
                                <input value="1" type="checkbox" name="open_in_new_window" checked="checked">
                                <i></i>
                            </label>{{ trans('ironside::dashboard/general.open-window') }}
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button id="modal-documents-submit" type="button" class="btn btn-primary" data-dismiss="modal">
                        {{ trans('ironside::dashboard/general.document.insert-document') }}
                    </button>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" charset="utf-8">
        var DocumentButton = function (context) {
            ...
            var button = ui.button({
                ...
                tooltip: '{{ trans('ironside::dashboard/general.document.insert-document-link-to-doc') }}',
                click: function () {
                    // open modal
