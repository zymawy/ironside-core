...
// website assets
if (COMPILE == 'website' || COMPILE == 'all') {// mix.sass('resources/assets/sass/vendor.scss', pathCSS)//     .setPublicPath('resources');}

// dashboard assets
    if (COMPILE == 'dashboard' || COMPILE == 'all') {

        var path = pathBase + '/';
        var pathCSS = path + '/dashboard/css/';
        var pathJS = path + '/dashboard/js/';

        var path = pathBase + '/dashboard/';
        ...
        // Icons
        mix.copy(pathBase + '/dashboard/icons', public + '/icons');
        // copy all the images
        mix.copy(path + 'images', public + '/images/dashboard');
        //style
        mix.styles([
            pathCSS + 'style.css',
        ...
        ], public + '/css/dashboard/style-rtl.css')
        //animate
        mix.styles([
            pathCSS + 'animate.css',
        ], public + '/css/dashboard/animate.css')
        //helper
        mix.styles([
            pathCSS + 'helper.css',
        ], public + '/css/dashboard/helper.css')
        //spinners
        mix.styles([
            pathCSS + 'spinners.css',
        ], public + '/css/dashboard/spinners.css')
        //spinners
        mix.styles([
            //-- Bootstrap Assets...
            pathCSS + 'lib/bootstrap/bootstrap.min.css',
        ], public + '/css/dashboard/bootstrap.css')
        //semantic
        mix.styles([
            //-- Calendar2 Assets...
            pathCSS + 'lib/calendar2/semantic.ui.min.css',
            pathCSS + 'lib/calendar2/pignose.calendar.min.css',
        ], public + '/css/dashboard/calendar2.css')
        //carousel
        mix.styles([
            //-- carousel Assets...
            pathCSS + 'lib/owl.carousel.min.css',
            pathCSS + 'lib/owl.theme.default.min.css',
        ], public + '/css/dashboard/carousel.css')
        ...
        ], public + '/js/dashboard/slimscroll.js')

        mix.scripts([
            // sidebarmenu
            pathJS + 'sidebarmenu.js',
        ], public + '/js/dashboard/sidebarmenu.js')
        ...
        ], public + '/js/dashboard/sticky-kit.js')
        ...
        ], public + '/js/dashboard/morris-chart.js')
